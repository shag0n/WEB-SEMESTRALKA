...
class db {
     ...
     * @param array $where_array - seznam podmínek [] - column = sloupec; value - int nebo string nebo value_mysql = now(); symbol
...
//echo "`$column` $symbol  $value_pom ";
     ...
     */
    public function DBUpdate($table_name, $update_string, $where_array, $limit_string = "") {
        ...
        // 1) pripravit dotaz s dotaznikama
        $query = "Update " . $table_name . " " . "SET " . $update_string . " $where_pom $limit_string;";
